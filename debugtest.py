...
if __name__ == "__main__":
    ...
    #     print(labelb[0][0,5,5,1, 2:4])

    lines_train, lines_validation = yolo_t.read_and_split_annotations()
    ...
    with tf.name_scope("optimizer"):
        ...
        training_op = optimizer.minimize(loss, var_list = variables_unfrozen)
